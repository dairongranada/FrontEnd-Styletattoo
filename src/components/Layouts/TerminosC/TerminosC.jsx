      ...
      <div className='cont1'>
        <div className='contInfo'>
          ...
          <div className='contSecciones'>
            ...
            <div className='ContButtonAcep'>
              <a className='BntAceptarterminos ' href="/Registro"><button className='buttons_global_StyleTatto' type='sumbit'>Aceptar Terminos</button></a>
            </div>
          </div>
        </div>
      </div></>
